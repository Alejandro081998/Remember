...
public class AdaptadorRutinasPacientes extends ArrayAdapter<Rutinas>  {

    private Session ses;

    public AdaptadorRutinasPacientes(Context context, List<Rutinas> objetos) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View item = inflater.inflate(R.layout.item_listado_rutinas_paciente, null);
        ...
        LinearLayout marco = (LinearLayout) item.findViewById(R.id.marco_paciente);
