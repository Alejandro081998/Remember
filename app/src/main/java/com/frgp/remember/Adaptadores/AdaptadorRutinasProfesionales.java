...
public class AdaptadorRutinasProfesionales extends ArrayAdapter<Rutinas>  {

    private Session ses;

    public AdaptadorRutinasProfesionales(Context context, List<Rutinas> objetos) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View item = inflater.inflate(R.layout.item_listado_rutinas_profesionales, null);
        ...
        LinearLayout marco = (LinearLayout) item.findViewById(R.id.marco_profesional);
        ...
        Log.d("PACIENTEADAPTADOR:" , "" + getItem(position).getId_creador().getNombre());
